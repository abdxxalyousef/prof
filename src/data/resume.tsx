...
export const DATA = {
  ...
  description:
    "Cyber security student in JUST",
  summary:
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          title: "Client Source",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/RTSPClient",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: "Source",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/genecis",
        },
      ],
    },
    {
      ...
      links: [
        ...
        },
        {
          title: "Source",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/pocketdoc-react-native",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          href: "https://www.instagram.com/abdalrahman_alqashiverma",
        },
        {
          title: "Source",
          icon: <Icons.github className="h-4 w-4" />,
      ...
      links: [
        {
          title: "Source",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/earthwatch",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: "Source",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/threejs-planes",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: "Source (Mobile)",
          icon: <Icons.github className="h-4 w-4" />,
          href: "https://github.com/Abdalrahman Alqashiverma/human-huntr-react-native",
        },
        {
          title: "Source (API)",
          icon: <Icons.github className="h-4 w-4" />,
